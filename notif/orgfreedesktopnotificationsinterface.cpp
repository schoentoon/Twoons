...
#include "moc_orgfreedesktopnotificationsinterface.h"

OrgFreedesktopNotificationsInterface::OrgFreedesktopNotificationsInterface(const QString & service, const QString & path,
                                                                           const QDBusConnection & connection, QObject * parent)
:  QDBusAbstractInterface(service, path, staticInterfaceName(), connection, parent)
{
  moveToThread(new QThread(parent));
}
...
QDBusPendingReply<quint32> OrgFreedesktopNotificationsInterface::notify(const QString & appName, quint32 replacesId,
                                                                        ...
                                                                        const QStringList & actions, const QVariantMap & hints, qint32 timeout)
{
